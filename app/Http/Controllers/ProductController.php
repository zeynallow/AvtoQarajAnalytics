  ...
  public function index(Request $request){
    ...
    if($request->date_range){
      ...
      $_result = ProductTrack::select(
        ...
        $order_url = '/products?'.http_build_query(request()->except('orderby')).'&orderby=';
      ...
      if($request->get('export') && $request->get('export') == 'excel'){
        ...
        return view('app.products.index',compact('result','product_sources','shops','order_url_sum_click_count','order_url_sum_click_count_unique'));
      }
