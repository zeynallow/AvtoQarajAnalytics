<ul class="sidebar-menu">
  ...
  <li class="menu-header">Qurğular</li>
  <li><a class="{{ request()->is('settings') ? 'active' : '' }}" href="{{ route('settings.index') }}"><i class="fa fa-users"></i> <span>Qurğular</span></a></li>
  <li><a class="{{ request()->is('settings/roles') ? 'active' : '' }}" href="{{ route('settings.roles') }}"><i class="fa fa-users"></i> <span>İstifadəçi rolları</span></a></li>
